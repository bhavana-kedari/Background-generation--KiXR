...
login(token ="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")
import gradio as gr
import torch
...
pipe = StableDiffusionXLControlNetPipeline.from_pretrained("stabilityai/stable-diffusion-xl-base-1.0", controlnet=controlnet, torch_dtype=torch.float16, vae=vae).to('cuda:0')
